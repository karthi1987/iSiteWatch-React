...
/***/ function(module, exports, __webpack_require__) {
	...
	/*
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                *
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */var
	Avatar = function (_React$Component) {_inherits(Avatar, _React$Component);function Avatar() {_classCallCheck(this, Avatar);return _possibleConstructorReturn(this, (Avatar.__proto__ || Object.getPrototypeOf(Avatar)).apply(this, arguments));}_createClass(Avatar, [{ key: 'render', value: function render()
			{var _props =



				this.props,avatar = _props.avatar,className = _props.className,firstName = _props.firstName,lastName = _props.lastName;

				if (avatar) {
					return _react2.default.createElement('img', { className: 'avatar-image ' + className + '-avatar-image', src: avatar });
				} else if (firstName && lastName) {
					return (
						_react2.default.createElement('span', { className: 'avatar-initials ' + className + '-avatar-initials' },
							firstName.charAt(0) + lastName.charAt(0)));


				} else {
					return _react2.default.createElement('span', { className: 'avatar-initials ' + className + '-avatar-initials' });
				}

			} }]);return Avatar;}(_react2.default.Component);


	Avatar.propTypes = {
		className: _react2.default.PropTypes.string,
		avatar: _react2.default.PropTypes.oneOfType([
		_react2.default.PropTypes.string,
		_react2.default.PropTypes.bool]),

		firstName: _react2.default.PropTypes.string,
		lastName: _react2.default.PropTypes.string };exports.default =
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*
	                ...
	                */
	var Filters = (0, _utils.connectAndMap)(
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*
	 * why is this in the utils folder?
	 * there was a warning being caused by the 1.3 version, that was fixed in 2.0.0alpha. tt was a simple fix, which got rid of a redundant warning.
	 *
	 * this fix has been applied to react-dimensions 1.3, and the dependency was moved to the utils folder, so that the fix would stay with the project and wouldn't
	 * get overwritten in another install.

	 * issue: https://github.com/digidem/react-dimensions/pull/43
	 */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */ /*
	     * 1. Agenda
	     */var Leaderboard = (0, _utils.connectAndMap)(['views.leaderboard', 'app.session', 'app.loadingErrors', 'app.loaded'],
	{ getLeaderboardData: _leaderboardActionsReducers.getLeaderboardData, clearLeaderboardData: _leaderboardActionsReducers.clearLeaderboardData })(function (_React$Component) {_inherits(_class, _React$Component);function _class() {_classCallCheck(this, _class);return _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).apply(this, arguments));}_createClass(_class, [{ key: 'componentWillMount', value: function componentWillMount()



	        {
	            var hierarchyIds = this.props.leaderboard.hierarchy.ids;
	        ...
	        nextProps) {
	            var hierarchyIds = nextProps.leaderboard.hierarchy.ids;

	            if (
	            this.props.session.refresh !== nextProps.session.refresh ||
	            !(0, _lodash.isEqual)(this.props.leaderboard.hierarchy.ids, hierarchyIds))
	            {
	                this.props.getLeaderboardData(hierarchyIds);
	            }
	        }
	        ...
	        /*
	           ...
	           */ }, { key: 'filterData', value: function filterData(
	        hierarchyIds) {
	            this.props.getLeaderboardData(hierarchyIds);
	        } }, { key: 'render', value: function render()
	        ...
	        {var
	            ...
	            var leaderboardViewLoaded = this.props.loaded.leaderboardViewData;
	            var leaderboardViewError = this.props.loadingErrors.leaderboardViewData;

	            return (
	                _react2.default.createElement('div', { className: 'leaderboard-wrapper' },

	                    _react2.default.createElement(_filters2.default, { drilldown: this.props.leaderboard.drilldown,
	                    ...
	                    _react2.default.createElement(_errorMessage2.default, { message: leaderboardViewError }),


	                    leaderboardViewLoaded && !leaderboardViewError &&

	                    _react2.default.createElement('div', { className: 'leaderboard-container' },
	                        _react2.default.createElement('div', { className: 'leaderboard-left' },

	                            data && data.leaderboards && data.leaderboards.length > 0 &&

	                            _react2.default.createElement(Masthead, data.location),



	                            data && data.topRanks && data.topRanks.length > 0 &&

	                            _react2.default.createElement(TopRanks, { userId: this.props.userId, topRanks: data.topRanks })),



	                        _react2.default.createElement('div', { className: 'leaderboard-right' },

	                            data && data.leaderboards && data.leaderboards.length > 0 && data.location &&

	                            _react2.default.createElement(RanksTable, { leaderboards: data.leaderboards, rank: data.location.rank })))));
	...
	/*
	                                                            ...
	                                                            */var
	Masthead = function (_React$Component2) {_inherits(Masthead, _React$Component2);function Masthead() {_classCallCheck(this, Masthead);return _possibleConstructorReturn(this, (Masthead.__proto__ || Object.getPrototypeOf(Masthead)).apply(this, arguments));}_createClass(Masthead, [{ key: 'render', value: function render()

	        {var _props =


	            this.props,name = _props.name,metricName = _props.metricName,startDate = _props.startDate,endDate = _props.endDate;

	            return (
	                _react2.default.createElement('div', { className: 'leaderboard-participant-header' },
	                    _react2.default.createElement('div', { className: 'show-grid' },


	                        _react2.default.createElement('div', null,
	                            _react2.default.createElement('h1', { className: 'leaderboard-participant-first-name' }, (0, _utils.formatNameString)(name))),


	                        _react2.default.createElement('div', null,
	                            _react2.default.createElement('h2', { className: 'leaderboard-participant-metric-name' }, (0, _utils.formatMetricString)(metricName)),
	                            _react2.default.createElement('h3', { className: 'leaderboard-participant-start-date' }, (0, _momentTimezone2.default)(new Date(startDate)).format('MMM D') + ' - ' + (0, _momentTimezone2.default)(new Date(endDate)).format('MMM D'))))));




	        } }]);return Masthead;}(_react2.default.Component);
	...
	/*
	                                                             ...
	                                                             */var
	TopRanks = function (_React$Component3) {_inherits(TopRanks, _React$Component3);
	    function TopRanks(props) {_classCallCheck(this, TopRanks);var _this3 = _possibleConstructorReturn(this, (TopRanks.__proto__ || Object.getPrototypeOf(TopRanks)).call(this,
	        props));
	        _this3.state = {
	            height: 1,
	            medallionTop: 0 };return _this3;

	    }_createClass(TopRanks, [{ key: 'componentDidMount', value: function componentDidMount()
	        {var _this4 = this;

	            /*
	                             * give TopRanks half a second to get a height before we setTop
	                             */
	            setInterval(function () {_this4.setStyles();}, 500);
	        }
	        ...
	        {var _this5 = this;var
	            ...
	            this.props.topRanks,height = this.state.height;

	            return (
	                _react2.default.createElement('div', { className: 'top-ranks', ref: function ref(_ref) {return _this5.topRanks = _ref;} },

	                    topRanks && topRanks.length &&

	                    topRanks.map(
	                    function (leaderboard, i) {return (
	                            _react2.default.createElement('div', { key: i,
	                                    id: 'top-rank-' + (i + 1),
	                                    className: 'top-rank top-rank-' + (i + 1) },
	                                _react2.default.createElement(TopRank, {
	                                    layoutRank: i + 1,
	                                    leaderboard: leaderboard,
	                                    height: height,
	                                    viewportWidth: _this5.props.viewportWidth,
	        ...
	        } }]);return TopRanks;}(_react2.default.Component);
	...
	/*
	                                                             ...
	                                                             */
	var TopRank = (0, _reactDimensions2.default)()(function (_React$Component4) {_inherits(_class2, _React$Component4);

	    function _class2(props) {_classCallCheck(this, _class2);var _this6 = _possibleConstructorReturn(this, (_class2.__proto__ || Object.getPrototypeOf(_class2)).call(this,
	        props));
	        _this6.state = {
	            rankTop: 0,
	            rankFontSize: 0,
	            ...
	            rankInfoTop: 0,
	            rankInfoFontSize: 0,
	            rankIconSize: 0 };return _this6;

	    }_createClass(_class2, [{ key: 'componentDidMount', value: function componentDidMount()
	        ...
	        /*
	           ...
	           */ }, { key: 'setRankLayout', value: function setRankLayout()
	        {var _this7 = this;
	            setTimeout(
	            function () {
	                var medallionHeight = _this7.medallion.clientHeight;
	                _this7.setState({
	                    ...
	                    rankInfoTop: medallionHeight + medallionHeight * (_this7.props.layoutRank === 1 ? .25 : .3) });
	        ...
	        shadowElement) {
	            ...
	            var shadowWidth = 375;
	            var shadowX = shadowWidth * .4;
	            var shadowHeight = 375 * .2;
	            var shadowY = shadowHeight / 3;

	            shadowSvg.attr({ viewBox: '0 0 ' + shadowWidth + ' ' + shadowHeight });

	            var ellipse = shadowSvg.ellipse(shadowWidth / 2, shadowHeight / 2, shadowX - blur, shadowY - blur);
	        ...
	        {var _this8 = this;var _props2 =
	            ...
	            this.props,leaderboard = _props2.leaderboard,containerWidth = _props2.containerWidth,userId = _props2.userId,layoutRank = _props2.layoutRank,_state = this.state,rankFontSize = _state.rankFontSize,firstRankLeft = _state.firstRankLeft;

	            return (
	                _react2.default.createElement('div', { className: 'medallion medallion-' + layoutRank,
	                        id: 'medallion-' + layoutRank,
	                        ref: function ref(_ref3) {return _this8.medallion = _ref3;},
	                        style: {
	                            backgroundImage: leaderboard.avatar ? 'url(' + leaderboard.avatar + ')' : null,
	                            width: containerWidth,
	                            height: containerWidth } },

	                    _react2.default.createElement('h1', { className: 'leaderboard-rank' },
	                        _react2.default.createElement('span', { className: 'leaderboard-rank-number', style: {
	                                    fontSize: rankFontSize,
	                                    left: leaderboard.rank === 1 ? firstRankLeft : 'auto' } },

	                            leaderboard.rank),

	                        _react2.default.createElement('span', { className: 'leaderboard-rank-ordinal', style: {} },
	                            _appLang.LEADERBOARD_VIEW.ORDINAL_INDICATORS[leaderboard.rank])),


	                    _react2.default.createElement('div', { className: 'top-rank-info', style: {} },
	                        _react2.default.createElement('h1', { className: 'top-rank-info-name' },

	                            Number(leaderboard.ownerPaxId) === Number(userId) ?

	                            _appLang.LEADERBOARD_VIEW.YOU :

	                            (0, _utils.formatNameString)(leaderboard.firstName) + ' ' + (0, _utils.formatNameString)(leaderboard.lastName)),


	                        _react2.default.createElement('h2', { className: 'top-rank-info-total' },
	                            _react2.default.createElement(_icons2.default, { name: _appLang.LEADERBOARD_VIEW.CHANGE_CODE_ICON_NAMES[leaderboard.changeCode],
	                                svgStyle: { height: '2em', width: '2em' } }),
	                            _react2.default.createElement('span', { className: 'top-rank-info-total-text', style: { lineHeight: '1em' } },
	                                (0, _utils.formatNumeral)(leaderboard.total, leaderboard.valueType)))),



	                    _react2.default.createElement('svg', { className: 'shadow', width: '100%', height: '100px', ref: function ref(_ref2) {return _this8.shadow = _ref2;} })));
	...
	/*
	                                                             ...
	                                                             */var
	RanksTable = function (_React$Component5) {_inherits(RanksTable, _React$Component5);function RanksTable() {_classCallCheck(this, RanksTable);return _possibleConstructorReturn(this, (RanksTable.__proto__ || Object.getPrototypeOf(RanksTable)).apply(this, arguments));}_createClass(RanksTable, [{ key: 'renderIcon',
	        ...
	        iconCode) {
	            ...
	            switch (iconCode) {
	                case 'E':
	                    return _react2.default.createElement(StaticArrow, null);
	                case 'I':
	                    return _react2.default.createElement(PositiveArrow, null);
	                case 'D':
	                    return _react2.default.createElement(NegativeArrow, null);}
	        ...
	        {var _props3 =
	            ...
	            this.props,leaderboards = _props3.leaderboards,userId = _props3.userId;

	            return (
	                _react2.default.createElement('div', { className: 'leaderboard-table-wrapper leaderboard-table ' },
	                    _react2.default.createElement('div', { className: 'leaderboard-table-header' },
	                        _react2.default.createElement('div', { className: 'leaderboard-table-rank leaderboard-table-header-cell rank-table-header' },
	                            _appLang.LEADERBOARD_VIEW.RANK_TABLE_HEADER),

	                        _react2.default.createElement('div', { className: 'leaderboard-table-change leaderboard-table-header-cell change-table-header' },

	                            _appLang.LEADERBOARD_VIEW.CHANGE_TABLE_HEADER),


	                        _react2.default.createElement('div', { className: 'leaderboard-table-name leaderboard-table-header-cell name-table-header' },
	                            _appLang.LEADERBOARD_VIEW.NAME_TABLE_HEADER),

	                        _react2.default.createElement('div', { className: 'leaderboard-table-total leaderboard-table-header-cell total-table-header' },
	                            _appLang.LEADERBOARD_VIEW.TOTAL_TABLE_HEADER)),
	                    ...
	                    //     </div>
	                    // </div>
	                    _react2.default.createElement('div', { className: 'leaderboard-table-body' },

	                        leaderboards.slice(3).map(
	                        function (leaderboard, i) {return (
	                                _react2.default.createElement('div', { key: i, className: 'leaderboard-row' },
	                                    _react2.default.createElement('div', { className: 'leaderboard-table-rank leaderboard-row-data rank-row-data' },
	                                        _react2.default.createElement('div', { className: 'rank-row-data-rank' },
	                                            leaderboard.rank)),


	                                    _react2.default.createElement('div', { className: 'leaderboard-table-change leaderboard-row-data change-row-data' },
	                                        _react2.default.createElement(_icons2.default, { name: _appLang.LEADERBOARD_VIEW.CHANGE_CODE_ICON_NAMES[leaderboard.changeCode] })),


	                                    _react2.default.createElement('div', { className: 'leaderboard-table-name leaderboard-row-data name-row-data' },
	                                        _react2.default.createElement(_avatar2.default, { className: 'leaderboard',
	                                            ...
	                                            (0, _utils.formatNameString)(leaderboard.firstName),
	                                            ...
	                                            (0, _utils.formatNameString)(leaderboard.lastName) }),



	                                        _react2.default.createElement('div', { className: 'name-row-data-name' },
	                                    ...
	                                    _react2.default.createElement('div', { className: 'leaderboard-table-total leaderboard-row-data total-row-data' },
	                                        _react2.default.createElement('div', { className: 'total-row-data-value' }, ' ', (0, _utils.formatNumeral)(leaderboard.total, leaderboard.valueType), ' '))));}))));
	        ...
	        } }]);return RanksTable;}(_react2.default.Component);
	...
	var PositiveArrow = function PositiveArrow() {return (
	        _react2.default.createElement('svg', { viewBox: '0 0 25 25', className: 'icon icon-positive-arrow' },
	...
	var NegativeArrow = function NegativeArrow() {return (
	        _react2.default.createElement('svg', { viewBox: '0 0 25 25', className: 'icon icon-negative-arrow' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/postcss-loader/index.js!../../../../node_modules/sass-loader/index.js!./avatar.scss", function() {
				var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/postcss-loader/index.js!../../../../node_modules/sass-loader/index.js!./avatar.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/postcss-loader/index.js!../../../../node_modules/sass-loader/index.js!./leaderboard.scss", function() {
				var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/postcss-loader/index.js!../../../../node_modules/sass-loader/index.js!./leaderboard.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
